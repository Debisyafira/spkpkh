                            ...
                            <form action="{{ route('admin.editCriteria') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" placeholder="Nama Kriteria" name="type">
                                        <option value="1" @if ($criteria->type == 1) selected @endif>Benefit
                                        </option>
                                        <option value="0" @if ($criteria->type == 0) selected @endif>Cost
                                        </option>
                                    </select>
                                </div>
                ...
                <tbody>
                    @foreach ($subcriteria as $sub)
                        <tr>
                            ...
                            <td>{{ $sub['nilai'] }}</td>
                            <td>
                                <a href="{{ route('admin.deleteSubCriteria', $sub['id']) }}"
