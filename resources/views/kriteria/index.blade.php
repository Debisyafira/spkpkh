                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if(auth()->user()->role->value == "ADMIN" || auth()->user()->role->value == "OPT" )
                                <td>
                                    <a href="{{ route('admin.subcriteria', $criteria['id']) }}" class="btn btn-info btn-circle">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('admin.editRatioCriteria', ['id' => $ratio['id']]) }}" class="btn btn-info btn-circle">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </div>
                                </td>
